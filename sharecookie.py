...
\033[1;34m╚═════════════════════════════════════════════════
\033[1;34m╔═════════════════════════════════════════════════         
\033[1;36m║➢ Facebook  : Razz Mokouhda
\033[1;36m║➣ Tool  : Auto share                 
\033[1;34m╚═════════════════════════════════════════════════
          ''')
...
def main_share():
    clear()
    banner()
    input_file = open(input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1m\033[38;5;51mfile Cookies: \033[1;35m")).read().split('\n')
    id_share = input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1m\033[38;5;51mPOST ID  Share: \033[1;35m")
    delay = int(input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1m\033[38;5;51mDelay Share: \033[1;35m"))
    total_share = int(input("\033[1;31m[\033[1;37m=.=\033[1;31m] \033[1;37m=> \033[1m\033[38;5;51mHow Many Shares Will The Tool Stop: \033[1;35m"))
    ...
    while True:
        ...
        if stt == total_share:
            break
    gome_token.clear()
    input('\033[38;5;245m[\033[1;32mSUCCESS\033[38;5;245m] \033[1;32mShare successful | Press [Enter] To Run Again \033[0m\033[0m')
while True:
    try:
        main_share()
    except KeyboardInterrupt:
        print('\n\033[38;5;245m[\033[38;5;9m!\033[38;5;245m] \033[38;5;9mscript admin Niño Infiesto ^^\033[0m')
        sys.exit()